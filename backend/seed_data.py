...
DEFAULT_TAX_SETTINGS = {
    ...
    "taxes": [
        ...
        {"code": "PPH21", "name": "PPh Pasal 21 (Karyawan)", "rate": 5.0, "account": "2-10002",
         "kind": "wht", "desc": "Pemotongan atas penghasilan orang pribadi/karyawan. Tarif progresif, sesuaikan."},
        ...
        {"code": "PPH42_KONSTRUKSI", "name": "PPh Pasal 4(2) - Jasa Konstruksi Final (2,65%)", "rate": 2.65, "account": "2-10005",
         "kind": "wht", "desc": "PPh Final jasa konstruksi (pelaksana kualifikasi kecil 1,75% / menengah-besar 2,65% / non-kualifikasi 4%)."},
